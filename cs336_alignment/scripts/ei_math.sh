...
# 显式定义要运行的配置文件列表
JSON_PATH=(
    "cs336_alignment/configs/ei_math_512_4.json"
    "cs336_alignment/configs/ei_math_1024_4.json"
    "cs336_alignment/configs/ei_math_2048_4.json"
)
...
for json_path in "${JSON_PATH[@]}"; do
  ...
  # 执行当前的训练脚本
  python cs336_alignment/train_ei.py --json_path "${json_path}"
