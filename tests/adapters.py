...
def run_tokenize_prompt_and_output(
    ...
    try:
        ...
        print(f"Error in run_tokenize_prompt_and_output: {e}")
        raise e
...
def run_compute_group_normalized_rewards(
    ...
    uv run pytest -k test_compute_group_normalized_rewards --ignore=reference
    """
    try:
...
def run_compute_entropy(logits: torch.Tensor) -> torch.Tensor:
    ...
    # uv run pytest -k test_compute_entropy --ignore=reference --ignore=vendor
    raise NotImplementedError
...
def run_get_response_log_probs(
    ...
    # uv run pytest -k test_get_response_log_probs --ignore=reference --ignore=vendor
    except Exception as e:
        print(e)
    raise NotImplementedError
...
def run_compute_naive_policy_gradient_loss(
    ...
    uv run pytest -k test_compute_naive_policy_gradient_loss --ignore=reference --ignore=vendor
    """
    try:
...
def run_compute_grpo_clip_loss(
    ...
    uv run pytest -k test_compute_grpo_clip_loss --ignore=reference --ignore=vendor
    """
    try:
...
def run_compute_policy_gradient_loss(
    ...
    uv run pytest -k test_compute_policy_gradient_loss --ignore=reference --ignore=vendor
    """
    try:
...
def run_masked_mean(tensor: torch.Tensor, mask: torch.Tensor, dim: int | None = None) -> torch.Tensor:
    ...
    uv run pytest -k test_masked_mean --ignore=reference --ignore=vendor
    """
    try:
...
def run_sft_microbatch_train_step(
    ...
    uv run pytest -k test_sft_microbatch_train_step --ignore=reference --ignore=vendor
    """
    try:
...
def run_grpo_microbatch_train_step(
    ...
    uv run pytest -k test_grpo_microbatch_train_step --ignore=reference --ignore=vendor
    """
    try:
...
def run_masked_normalize(
    ...
    uv run pytest -k test_masked_normalize --ignore=reference --ignore=vendor
    """
    try:
